...
summary(g00)
Anova(g00, type = 2)
emtrends(g00, ~Temp, var="log10_Weight")
summary(g15)
confint(g15)
summary(g20)
confint(g20)
...
data2_RMR$log10_Metric_absolute<-log10(data2_RMR$Metric_absolute)
r00<-lm(data=data2_RMR, log10_Metric_absolute~log10_Weight*Temp)
emtrends(r00, ~Temp, var="log10_Weight")
Anova(r00, type = 2)
...
summary(m00)
Anova(m00, type = 2)
emtrends(m00, ~Temp, var="log10_Weight")
summary(m15)
confint(m15)
summary(m20)
confint(m20)
