...
vf1 <- .0066 # Fish volume in litres (1L = 1kg)
vf2 <- .0041
vf3 <- .0049
vf4 <- .0052
vf5 <- .0053
...
PCrit_Raw <- read.delim("PCRIT_2_20C_initial_raw.txt")
write_csv(PCrit_Raw,'PCRIT_2_20C_initial_raw.csv')
PCrit_Raw_modified <- read_delim("PCRIT_2_20C_initial_raw.csv", 
...
write_csv(combined_PCrit_FinalData,'20C_2_PCrit_initial_06262023.csv')
