...
vf1 <- .0054 # Fish volume in litres (1L = 1kg)
vf2 <- .0055
vf3 <- .0077
vf4 <- .0051
vf5 <- .0045
...
PCrit_Raw <- read.delim("PCRIT_1_15C_initial_raw.txt")
write_csv(PCrit_Raw,'PCRIT_1_15C_initial_raw.csv')
PCrit_Raw_modified <- read_delim("PCRIT_1_15C_initial_raw.csv", 
...
write_csv(combined_PCrit_FinalData,'15C_1_PCrit_initial_06262023.csv')
