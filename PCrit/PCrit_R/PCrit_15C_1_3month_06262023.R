...
vf1 <- .0259 # Fish volume in litres (1L = 1kg)
vf2 <- .0325
vf3 <- .0237
vf4 <- .0400
vf5 <- .0209
...
PCrit_Raw <- read.delim("PCRIT_1_15C_3month_raw.txt")
write_csv(PCrit_Raw,'PCRIT_1_15C_3month_raw.csv')
PCrit_Raw_modified <- read_delim("PCRIT_1_15C_3month_raw.csv", 
...
write_csv(combined_PCrit_FinalData,'15C_1_PCrit_06262023.csv')
...
tiff(filename = "Tank7_Final_PCrit_15C_1_06262023.tiff",
     width = 6, height = 6, units = "in", res = 600)
plot_pcrit(Tank7_Pcrit_MO2_converted_final$O2_MEAN, Tank7_Pcrit_MO2_converted_final$MO2mgkghr, MR = MR7)
dev.off()

tiff(filename = "Tank8_Final_PCrit_15C_1_06262023.tiff",
     width = 6, height = 6, units = "in", res = 600)
...
ggplot(Tank7_Pcrit_converted, aes(x = Loop, y = DOpercent)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 7 Trial 15C 1", x = "Time", y = "O2 (%)") +
  theme_classic()

ggsave('PCrit_FullRun_Tank7_15C_1_qualitycontrol.tiff')

ggplot(Tank8_Pcrit_converted, aes(x = Loop, y = DOpercent)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 8 Trial 15C 1", x = "Time", y = "O2 (%)") +
  theme_classic()

ggsave('PCrit_FullRun_Tank8_15C_1_qualitycontrol.tiff')
...
ggsave('PCrit_FullRun_Tank7_15C_1_postqualitycontrol.tiff')
...
ggsave('PCrit_FullRun_Tank8_15C_1_postqualitycontrol.tiff')
...
ggplot(Tank7_Pcrit_MO2_converted_final, aes(x = O2_MEAN, y = MO2mgkghr)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 7 Trial 15C 1", x = "O2 (%)", y = "MO2") +
  theme_classic()

ggsave('PCrit_Tank7_15C_1_06262023.tiff')

ggplot(Tank8_Pcrit_MO2_converted_final, aes(x = O2_MEAN, y = MO2mgkghr)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 8 Trial 15C 1", x = "O2 (%)", y = "MO2") +
  theme_classic()

ggsave('PCrit_Tank8_15C_1_06262023.tiff')
