...
vf1 <- .0477 # Fish volume in litres (1L = 1kg)
vf2 <- .0359
vf3 <- .0415
vf4 <- .0227
vf5 <- .0442
...
PCrit_Raw <- read.delim("PCRIT_2_15C_3month_raw.txt")
write_csv(PCrit_Raw,'PCRIT_2_15C_3month_raw.csv')
PCrit_Raw_modified <- read_delim("PCRIT_2_15C_3month_raw.csv", 
...
ggplot(Tank1_Pcrit_converted, aes(x = Loop, y = DOpercent)) + 
  ...
  labs(title = "Pcrit Tank 1 Trial 15C 2", x = "Time", y = "O2 (%)") +
  theme_classic()

ggsave('PCrit_FullRun_Tank1_15C_2_qualitycontrol.tiff')

ggplot(Tank2_Pcrit_converted, aes(x = Loop, y = DOpercent)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 2 Trial 15C 2", x = "Time", y = "O2 (%)") +
  theme_classic()

ggsave('PCrit_FullRun_Tank2_15C_2_qualitycontrol.tiff')

ggplot(Tank3_Pcrit_converted, aes(x = Loop, y = DOpercent)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 3 Trial 15C 2", x = "Time", y = "O2 (%)") +
  theme_classic()

ggsave('PCrit_FullRun_Tank3_15C_2_qualitycontrol.tiff')

ggplot(Tank4_Pcrit_converted, aes(x = Loop, y = DOpercent)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 4 Trial 15C 2", x = "Time", y = "O2 (%)") +
  theme_classic()

ggsave('PCrit_FullRun_Tank4_15C_2_qualitycontrol.tiff')

ggplot(Tank5_Pcrit_converted, aes(x = Loop, y = DOpercent)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 5 Trial 15C 2", x = "Time", y = "O2 (%)") +
  theme_classic()

ggsave('PCrit_FullRun_Tank5_15C_2_qualitycontrol.tiff')

ggplot(Tank6_Pcrit_converted, aes(x = Loop, y = DOpercent)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 6 Trial 15C 2", x = "Time", y = "O2 (%)") +
  theme_classic()

ggsave('PCrit_FullRun_Tank6_15C_2_qualitycontrol.tiff')

ggplot(Tank7_Pcrit_converted, aes(x = Loop, y = DOpercent)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 7 Trial 15C 2", x = "Time", y = "O2 (%)") +
  theme_classic()

ggsave('PCrit_FullRun_Tank7_15C_2_qualitycontrol.tiff')

ggplot(Tank8_Pcrit_converted, aes(x = Loop, y = DOpercent)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 8 Trial 15C 2", x = "Time", y = "O2 (%)") +
  theme_classic()

ggsave('PCrit_FullRun_Tank8_15C_2_qualitycontrol.tiff')
...
ggsave('PCrit_FullRun_Tank1_15C_2_postqualitycontrol.tiff')
...
ggsave('PCrit_FullRun_Tank2_15C_2_postqualitycontrol.tiff')
...
ggsave('PCrit_FullRun_Tank3_15C_2_postqualitycontrol.tiff')
...
ggsave('PCrit_FullRun_Tank4_15C_2_postqualitycontrol.tiff')
...
ggsave('PCrit_FullRun_Tank5_15C_2_postqualitycontrol.tiff')
...
ggsave('PCrit_FullRun_Tank6_15C_2_postqualitycontrol.tiff')
...
ggsave('PCrit_FullRun_Tank7_15C_2_postqualitycontrol.tiff')
...
ggsave('PCrit_FullRun_Tank8_15C_2_postqualitycontrol.tiff')

## This plots MO2 vs O2 ##

ggplot(Tank1_Pcrit_MO2_converted_final, aes(x = O2_MEAN, y = MO2mgkghr)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 1 Trial 15C 2", x = "O2 (%)", y = "MO2") +
  theme_classic()

ggsave('PCrit_Tank1_15C_2_06262023.tiff')

ggplot(Tank2_Pcrit_MO2_converted_final, aes(x = O2_MEAN, y = MO2mgkghr)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 2 Trial 15C 2", x = "O2 (%)", y = "MO2") +
  theme_classic()

ggsave('PCrit_Tank2_15C_2_06262023.tiff')

ggplot(Tank3_Pcrit_MO2_converted_final, aes(x = O2_MEAN, y = MO2mgkghr)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 3 Trial 15C 2", x = "O2 (%)", y = "MO2") +
  theme_classic()

ggsave('PCrit_Tank3_15C_2_06262023.tiff')

ggplot(Tank4_Pcrit_MO2_converted_final, aes(x = O2_MEAN, y = MO2mgkghr)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 4 Trial 15C 2", x = "O2 (%)", y = "MO2") +
  theme_classic()

ggsave('PCrit_Tank4_15C_2_06262023.tiff')

ggplot(Tank5_Pcrit_MO2_converted_final, aes(x = O2_MEAN, y = MO2mgkghr)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 5 Trial 15C 2", x = "O2 (%)", y = "MO2") +
  theme_classic()

ggsave('PCrit_Tank5_15C_2_06262023.tiff')

ggplot(Tank6_Pcrit_MO2_converted_final, aes(x = O2_MEAN, y = MO2mgkghr)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 6 Trial 15C 2", x = "O2 (%)", y = "MO2") +
  theme_classic()

ggsave('PCrit_Tank6_15C_2_06262023.tiff')

ggplot(Tank7_Pcrit_MO2_converted_final, aes(x = O2_MEAN, y = MO2mgkghr)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 7 Trial 15C 2", x = "O2 (%)", y = "MO2") +
  theme_classic()

ggsave('PCrit_Tank7_15C_2_06262023.tiff')

ggplot(Tank8_Pcrit_MO2_converted_final, aes(x = O2_MEAN, y = MO2mgkghr)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 8 Trial 15C 2", x = "O2 (%)", y = "MO2") +
  theme_classic()

ggsave('PCrit_Tank8_15C_2_06262023.tiff')