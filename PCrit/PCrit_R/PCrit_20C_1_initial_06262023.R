...
PCrit_Raw <- read.delim("PCRIT_1_20C_initial_raw.txt")
write_csv(PCrit_Raw,'PCRIT_1_20C_initial_raw.csv')
PCrit_Raw_modified <- read_delim("PCRIT_1_20C_initial_raw.csv", 
...
write_csv(combined_PCrit_FinalData,'20C_1_PCrit_initial_06262023.csv')
