...
MR1 <- 109.949949381959
MR2 <- NA
MR3 <- 95.7520662983982
MR4 <- 93.1499306316437
MR5 <- 137.234563881245
MR6 <- 114.431421442336
...
vf1 <- .1612 # Fish volume in litres (1L = 1kg)
vf2 <- NA
vf3 <- .1081
vf4 <- .1139
vf5 <- .0905
...
PCrit_Raw <- read.delim("PCRIT_2_20C_6month_raw.txt")
write_csv(PCrit_Raw,'PCRIT_2_20C_6month_raw.csv')
PCrit_Raw_modified <- read_delim("PCRIT_2_20C_6month_raw.csv", 
...
write_csv(combined_PCrit_FinalData,'20C_2_PCrit_6month_06262023.csv')
