...
MR1 <- 115.399933169934
MR2 <- 103.794610459011
MR3 <- 147.168869733993
MR4 <- 96.8803256169228
MR5 <- 142.987920982429
MR6 <- 124.318375915747
...
vf1 <- .0963 # Fish volume in litres (1L = 1kg)
vf2 <- .1044
vf3 <- .0941
vf4 <- .1184
vf5 <- .0961
...
PCrit_Raw <- read.delim("PCRIT_1_20C_6month_raw.txt")
write_csv(PCrit_Raw,'PCRIT_1_20C_6month_raw.csv')
PCrit_Raw_modified <- read_delim("PCRIT_1_20C_6month_raw.csv", 
...
write_csv(combined_PCrit_FinalData,'20C_1_PCrit_6month_06262023.csv')
