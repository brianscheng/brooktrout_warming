...
vf1 <- .1722 # Fish volume in litres (1L = 1kg)
vf2 <- .1222
vf3 <- .0953
vf4 <- .124
vf5 <- .221
...
PCrit_Raw <- read.delim("PCRIT_2_15C_6month_raw.txt")
write_csv(PCrit_Raw,'PCRIT_2_15C_6month_raw.csv')
PCrit_Raw_modified <- read_delim("PCRIT_2_15C_6month_raw.csv", 
...
write_csv(combined_PCrit_FinalData,'15C_2_PCrit_6month_06262023.csv')
