...
vf1 <- .0036 # Fish volume in litres (1L = 1kg)
vf2 <- .0055
vf3 <- .0048
vf4 <- .0065
vf5 <- .0082
...
PCrit_Raw <- read.delim("PCRIT_2_15C_initial_raw.txt")
write_csv(PCrit_Raw,'PCRIT_2_15C_initial_raw.csv')
PCrit_Raw_modified <- read_delim("PCRIT_2_15C_initial_raw.csv", 
...
write_csv(combined_PCrit_FinalData,'15C_2_PCrit_initial_06262023.csv')
