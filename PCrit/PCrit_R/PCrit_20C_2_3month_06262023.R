...
MR1 = 179.10164791117
MR2 = 170.44731050163
MR3 = 155.493864435785
MR4 = 152.421846399556
MR5 = 155.267273420343
MR6 = 153.610406052225
MR7 = 171.538038206865
MR8 = 197.253922800265
...
vf1 <- .0184 # Fish volume in litres (1L = 1kg)
vf2 <- .0268
vf3 <- .0164
vf4 <- .0277
vf5 <- .0285
...
PCrit_Raw <- read.delim("PCRIT_2_20C_3month_raw.txt")
write_csv(PCrit_Raw,'PCRIT_2_20C_3month_raw.csv')
PCrit_Raw_modified <- read_delim("PCRIT_2_20C_3month_raw.csv", 
...
ggplot(Tank1_Pcrit_converted, aes(x = Loop, y = DOpercent)) + 
  ...
  labs(title = "Pcrit Tank 1 Trial 20C 2", x = "Time", y = "O2 (%)") +
  theme_classic()

ggsave('PCrit_FullRun_Tank1_20C_2_qualitycontrol.tiff')

ggplot(Tank2_Pcrit_converted, aes(x = Loop, y = DOpercent)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 2 Trial 20C 2", x = "Time", y = "O2 (%)") +
  theme_classic()

ggsave('PCrit_FullRun_Tank2_20C_2_qualitycontrol.tiff')

ggplot(Tank3_Pcrit_converted, aes(x = Loop, y = DOpercent)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 3 Trial 20C 2", x = "Time", y = "O2 (%)") +
  theme_classic()

ggsave('PCrit_FullRun_Tank3_20C_2_qualitycontrol.tiff')

ggplot(Tank4_Pcrit_converted, aes(x = Loop, y = DOpercent)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 4 Trial 20C 2", x = "Time", y = "O2 (%)") +
  theme_classic()

ggsave('PCrit_FullRun_Tank4_20C_2_qualitycontrol.tiff')

ggplot(Tank5_Pcrit_converted, aes(x = Loop, y = DOpercent)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 5 Trial 20C 2", x = "Time", y = "O2 (%)") +
  theme_classic()

ggsave('PCrit_FullRun_Tank5_20C_2_qualitycontrol.tiff')

ggplot(Tank6_Pcrit_converted, aes(x = Loop, y = DOpercent)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 6 Trial 20C 2", x = "Time", y = "O2 (%)") +
  theme_classic()

ggsave('PCrit_FullRun_Tank6_20C_2_qualitycontrol.tiff')

ggplot(Tank7_Pcrit_converted, aes(x = Loop, y = DOpercent)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 7 Trial 20C 2", x = "Time", y = "O2 (%)") +
  theme_classic()

ggsave('PCrit_FullRun_Tank7_20C_2_qualitycontrol.tiff')

ggplot(Tank8_Pcrit_converted, aes(x = Loop, y = DOpercent)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 8 Trial 20C 2", x = "Time", y = "O2 (%)") +
  theme_classic()

ggsave('PCrit_FullRun_Tank8_20C_2_qualitycontrol.tiff')
...
ggsave('PCrit_FullRun_Tank1_20C_2_postqualitycontrol.tiff')
...
ggsave('PCrit_FullRun_Tank2_20C_2_postqualitycontrol.tiff')
...
ggsave('PCrit_FullRun_Tank3_20C_2_postqualitycontrol.tiff')
...
ggsave('PCrit_FullRun_Tank4_20C_2_postqualitycontrol.tiff')
...
ggsave('PCrit_FullRun_Tank5_20C_2_postqualitycontrol.tiff')
...
ggsave('PCrit_FullRun_Tank6_20C_2_postqualitycontrol.tiff')
...
ggsave('PCrit_FullRun_Tank7_20C_2_postqualitycontrol.tiff')
...
ggsave('PCrit_FullRun_Tank8_20C_2_postqualitycontrol.tiff')

## This plots MO2 vs O2 ##

ggplot(Tank1_Pcrit_MO2_converted_final, aes(x = O2_MEAN, y = MO2mgkghr)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 1 Trial 20C 2", x = "O2 (%)", y = "MO2") +
  theme_classic()

ggsave('PCrit_Tank1_20C_2_06262023.tiff')

ggplot(Tank2_Pcrit_MO2_converted_final, aes(x = O2_MEAN, y = MO2mgkghr)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 2 Trial 20C 2", x = "O2 (%)", y = "MO2") +
  theme_classic()

ggsave('PCrit_Tank2_20C_2_06262023.tiff')

ggplot(Tank3_Pcrit_MO2_converted_final, aes(x = O2_MEAN, y = MO2mgkghr)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 3 Trial 20C 2", x = "O2 (%)", y = "MO2") +
  theme_classic()

ggsave('PCrit_Tank3_20C_2_06262023.tiff')

ggplot(Tank4_Pcrit_MO2_converted_final, aes(x = O2_MEAN, y = MO2mgkghr)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 4 Trial 20C 2", x = "O2 (%)", y = "MO2") +
  theme_classic()

ggsave('PCrit_Tank4_20C_2_06262023.tiff')

ggplot(Tank5_Pcrit_MO2_converted_final, aes(x = O2_MEAN, y = MO2mgkghr)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 5 Trial 20C 2", x = "O2 (%)", y = "MO2") +
  theme_classic()

ggsave('PCrit_Tank5_20C_2_06262023.tiff')

ggplot(Tank6_Pcrit_MO2_converted_final, aes(x = O2_MEAN, y = MO2mgkghr)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 6 Trial 20C 2", x = "O2 (%)", y = "MO2") +
  theme_classic()

ggsave('PCrit_Tank6_20C_2_06262023.tiff')

ggplot(Tank7_Pcrit_MO2_converted_final, aes(x = O2_MEAN, y = MO2mgkghr)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 7 Trial 20C 2", x = "O2 (%)", y = "MO2") +
  theme_classic()

ggsave('PCrit_Tank7_20C_2_06262023.tiff')

ggplot(Tank8_Pcrit_MO2_converted_final, aes(x = O2_MEAN, y = MO2mgkghr)) + 
  geom_point(na.rm = TRUE) +  ##This means don't plot anything that has an NA 
  labs(title = "Pcrit Tank 8 Trial 20C 2", x = "O2 (%)", y = "MO2") +
  theme_classic()

ggsave('PCrit_Tank8_20C_2_06262023.tiff')
