...
convert.respirometry(import.file = "RMR_2_20C_raw.txt", 
                            export.file = "RMR_2_20C_raw_082721.txt", 
                            n.chamber = 8,
                            logger = "AutoResp",
                            from = "percent_a.s.", 
                            to = "mg_per_l", 
...
convert.respirometry(import.file = "Background_After_2_20C_raw.txt", 
                     export.file = "Background_After_2_20C_raw_082721.txt", 
                     n.chamber = 8,
                     logger = "AutoResp",
                     from = "percent_a.s.", 
                     to = "mg_per_l", 
...
convert.respirometry(import.file = "Background_Before_2_20C_real_raw.txt", 
                     export.file = "Background_Before_2_20C_raw_082721.txt", 
                     n.chamber = 8,
                     logger = "AutoResp",
                     from = "percent_a.s.", 
                     to = "mg_per_l", 
...
info <- input.info(ID = c("BT_1", "BT_3", "BT_4", "BT_5", "BT_7", "BT_8"),
                   Mass = c(6.6, 4.9, 5.2, 5.3, 7.0, 8.7),
                   Volume = c(656.4, 654, 658.6, 657.6, 654.4, 656.4),
                   DO.unit = "mg/L")

tiff(filename = "FullRun_Background_After_20C_2_082721.tiff",
     width = 6, height = 6, units = "in", res = 600)
post <- import.test(file = "Background_After_2_20C_raw_082721.txt", 
                    info.data = info, 
                    logger = "AutoResp",
                    n.chamber = 8,
...
tiff(filename = "FullRun_Background_Before_20C_2_082721.tiff",
     width = 6, height = 6, units = "in", res = 600)
pre <- import.test(file = "Background_Before_2_20C_raw_082721.txt", 
                    info.data = info, 
                    logger = "AutoResp",
                    n.chamber = 8,
                    plot.temperature = FALSE,
...
tiff(filename = "FullRun_RMR_20C_2_082721.tiff",
     width = 6, height = 6, units = "in", res = 600)
RMR.raw <- import.meas(file = "RMR_2_20C_raw_082721.txt",
                       info.data = info,
                       logger = "AutoResp",
                       n.chamber = 8,
                       date.format = "MDY",
...
RMR.slope_all <- extract.slope(RMR.clean,
                           method = "all",
                           r2 = 0.9)
tiff(filename = "RMR_alldata_20C_2_08272021_r2_0.9.tiff",
     width = 6, height = 6, units = "in", res = 600)
...
tiff(filename = "RMR_lowest25_20C_2_08272021_r2_0.9.tiff",
     width = 6, height = 6, units = "in", res = 600)
...
results_all <- export.MR(RMR_all,
                     file = "results_all_20C_2_08272021_R2>0.9.txt",
                     simplify = TRUE,
                     MS = FALSE,
                     plot.MS.abs = FALSE,
                     plot.MS.mass = FALSE,
...
results_lowest25 <- export.MR(RMR_lowest25,
                              file = "results_lowest25_20C_2_08272021_R2>0.9.txt",
                              simplify = TRUE,
                              MS = FALSE,
                              plot.MS.abs = FALSE,
                              plot.MS.mass = FALSE,
