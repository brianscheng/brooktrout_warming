...
convert.respirometry(import.file = "RMR_1_20C_raw.txt", 
                            export.file = "RMR_1_20C_converted_111321.txt", 
                            n.chamber = 8,
                            logger = "AutoResp",
                            from = "percent_a.s.", 
                            to = "mg_per_l", 
...
convert.respirometry(import.file = "Background_After_1_20C_raw.txt", 
                     export.file = "Background_After_1_20C_raw_111321.txt", 
                     n.chamber = 8,
                     logger = "AutoResp",
                     from = "percent_a.s.", 
                     to = "mg_per_l", 
...
convert.respirometry(import.file = "Background_Before_1_20C_raw.txt", 
                     export.file = "Background_Before_1_20C_raw_111321.txt", 
                     n.chamber = 8,
                     logger = "AutoResp",
                     from = "percent_a.s.", 
                     to = "mg_per_l", 
...
info <- input.info(ID = c("BT_1", "BT_2", "BT_3", "BT_4", "BT_5", "BT_6", "BT_7", "BT_8"),
                   Mass = c(17.4, 26.7, 32.3, 22.4, 38.6, 20.0, 15.2, 21.7),
                   Volume = c(726.8, 726.8, 726.8, 726.8, 726.8, 726.8, 726.8, 726.8),
                   DO.unit = "mg/L")

post <- import.test(file = "Background_After_1_20C_raw_111321.txt", 
                    info.data = info, 
                    logger = "AutoResp",
                    n.chamber = 8,
...
pre <- import.test(file = "Background_Before_1_20C_raw_111321.txt", 
                    info.data = info, 
                    logger = "AutoResp",
                    n.chamber = 8,
                    plot.temperature = FALSE,
...
RMR.raw <- import.meas(file = "RMR_1_20C_converted_111321.txt",
                       info.data = info,
                       logger = "AutoResp",
                       n.chamber = 8,
                       date.format = "MDY",
