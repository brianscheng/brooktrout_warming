...
MMR <- read.delim("MMR_1_20C_02102022_raw.txt")
write_csv(MMR,'MMR_1_20C_02212022.csv')
MMR_1_raw_df <- read_delim("MMR_1_20C_02212022.csv", 
...
ggsave('MMR_all_20C_1_6month_022122.tiff', width = 6, height = 4, units = "in")
...
write_csv(mergedBT_RR_df,'_MMR_all_20C_1_6month_042523.csv')
view(mergedBT_RR_df)
