...
MMR <- read.delim("MMR_1_15C_raw.txt")
write_csv(MMR,'MMR_1_15C.csv')
MMR_1_raw_df <- read_delim("MMR_1_15C.csv", 
...
ggsave('MMR_all_15C_1_3mont_111021.tiff', width = 8, height = 4, units = "in")
...
write_csv(mergedBT_RR_df,'_MMR_all_15C_1_3month_042523.csv')
view(mergedBT_RR_df)
