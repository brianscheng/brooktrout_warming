...
MMR <- read.delim("MMR_1_15C_02022022_raw.txt")
write_csv(MMR,'MMR_1_15C_02022022.csv')
MMR_1_raw_df <- read_delim("MMR_1_15C_02022022.csv", 
...
ggsave('MMR_all_15C_1_6month_020622.tiff', width = 6, height = 4, units = "in")
...
write_csv(mergedBT_RR_df,'_MMR_all_15C_1_6month_042523.csv')
view(mergedBT_RR_df)
