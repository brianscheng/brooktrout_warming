...
MMR <- read.delim("MMR_2_15C_raw.txt")
write_csv(MMR,'MMR_2_15C.csv')
MMR_1_raw_df <- read_delim("MMR_2_15C.csv", 
...
MMR_1_raw_df <- MMR_1_raw_df %>%
  mutate(pbar = patm/1000)
...
ggsave('MMR_all_15C_3month_2_111321.tiff', width = 8, height = 4, units = "in")
...
write_csv(mergedBT_RR_df,'_MMR_all_15C_3month_2_042523.csv')
view(mergedBT_RR_df)
