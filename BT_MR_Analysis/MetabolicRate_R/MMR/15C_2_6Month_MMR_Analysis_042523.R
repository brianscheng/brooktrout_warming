...
MMR <- read.delim("MMR_2_15C_02072022_raw.txt")
write_csv(MMR,'MMR_2_15C_02072022.csv')
MMR_1_raw_df <- read_delim("MMR_2_15C_02072022.csv", 
...
MMR_1_converted_df <- MMR_1_converted_df2
...
ggsave('MMR_all_15C_2_6month_020922.tiff', width = 6, height = 4, units = "in")
...
write_csv(mergedBT_RR_df,'_MMR_all_15C_2_6month_042523.csv')
view(mergedBT_RR_df)
