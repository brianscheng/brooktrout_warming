...
MMR <- read.delim("MMR_2_20C_raw.txt")
write_csv(MMR,'MMR_2_20C.csv')
MMR_1_raw_df <- read_delim("MMR_2_20C.csv", 
...
ggsave('MMR_all_20C_2_3month_111321.tiff', width = 8, height = 4, units = "in")
...
write_csv(mergedBT_RR_df,'_MMR_all_20C_2_3month_042523.csv')
view(mergedBT_RR_df)
